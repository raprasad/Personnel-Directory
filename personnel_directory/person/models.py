...
APPOINTMENT_TYPE_ID_NON_MCB_GRADUATE_STUDENT = 31

APPOINTMENT_TYPE_ID_FACULTY = 22
APPOINTMENT_TYPE_ID_STAFF = 28
...
class Person(models.Model):
    ...
    def privacy_info_link(self):
        ...
        try:
            ...
            return '<a href="%s?person=%s">Add Privacy Info</a>' % (change_url, self.id)
